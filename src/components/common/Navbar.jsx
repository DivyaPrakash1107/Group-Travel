        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <img className="h-12 w-auto" src="/logo.svg" alt="Travel Platform" />
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="bg-blue-600 text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors shadow-sm hover:shadow-md">
              Get Started
            </button>
          </div>
        </div>
